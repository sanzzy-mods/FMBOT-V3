...
let handler  = async (m, { conn, command, args, usedPrefix, DevMode }) => {
	...
	// ------- OTHER ------
  if (global.db.data.chats[m.chat].nsfw == false && m.isGroup) return conn.sendButton(m.chat, '[❗] Fitur Belum di aktifkan oleh admin!',botdate, thumb, null, [['ON NSFW', '.on nsfw']], m)
...
let next = 'NEXT ➡️'
let fot = cmenua
let txtprem = 'Fitur ini khusus user premium, untuk menggunakan fitur ini, Silahkan meng upgrade level anda ke *Premium* ❗'
let p = '🅟 | '
let f = 'Ⓕ | '
